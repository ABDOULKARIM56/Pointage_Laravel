...
<div class="bg-primary text-white shadow-sm d-none d-md-flex flex-column flex-shrink-0"
    ...
    <ul class="nav nav-pills flex-column mb-auto p-2" id="sidebarMenu">
        ...
        <li class="nav-item mb-1">
            <a href="{{ route('dashboard') }}" class="nav-link text-white" data-bs-toggle="pill"
        ...
        <li class="nav-item mb-1">
            <a href="{{ route('employe.ShowEmploye') }}" class="nav-link text-white">
                <i class="bi bi-people me-2"></i> Gestion des employés
            </a>
        </li>

        <li class="nav-item mb-1">
            <a href="{{ route('pointage.index') }}" class="nav-link text-white">
        ...
        <li class="nav-item mb-1">
            <a href="{{ route('settings.politique') }}" class="nav-link text-white">
        ...
        <li class="nav-item mt-2">
            ...
            <div class="collapse" id="settingsSubmenu">
                <ul class="nav flex-column ms-4 small">
                    <li class="mb-1"><a href="{{ route('show_service') }}" class="nav-link text-white"><i
                                class="bi bi-building me-2"></i> Services</a></li>
                    <li class="mb-1"><a href="{{ route('show_departement') }}" class="nav-link text-white"><i class="bi bi-diagram-3 me-2"></i> Départements</a></li>
                    <li class="mb-1"><a href="{{ route('show_conge') }}" class="nav-link text-white"><i
                                class="bi bi-calendar-check me-2"></i> Congés</a></li>
                    <li class="mb-1"><a href="{{ route('show_permission') }}" class="nav-link text-white"><i class="bi bi-shield-lock me-2"></i> Permissions</a></li>
                </ul>
            </div>
        </li>
    </ul>
